    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                <div class="p-4 m-3">
                    <img src="{{asset('img/logo1.jpeg')}}" alt="logo" width="120" class="shadow-light rounded-circle mb-5 mt-2">
                    <h4 class="text-dark font-weight-normal">Selamat Datang di <span class="font-weight-bold">Aplikasi SI AL-BUMAS</span></h4>
                    ...
                    <div class="text-center mt-5 text-small">
                        Copyright &copy; Puskesmas Malinau. Made with 💙 by Stisla
                    </div>
                </div>
            </div>
            <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="../img/backgroud.jpeg">
                <div class="absolute-bottom-left index-2">
                    <div class="text-light p-5 pb-2">
                        <div class="mb-5 pb-3">
                            <h1 class="mb-2 display-4 font-weight-bold">Puskesmas Malinau</h1>
                            <h5 class="font-weight-normal text-muted-transparent">Hulu Sungai Selatan, Indonesia</h5>
                        </div>
                    </div>
                </div>
            </div>
